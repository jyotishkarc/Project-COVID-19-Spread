...
We can start off by writing down a spectral decomposition of $C_2$, let's say $C_2 = D^{T}_2 \Sigma_2 D_2$ where $\Sigma_2$ is a diagonal matrix containing eigenvalues of $C_2$, and the rows of $D_2$ contain the corresponding eigenvectors.
